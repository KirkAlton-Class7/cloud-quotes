...
# ---------------------------------------------
# Generate metadata.json for /metadata endpoint
# ---------------------------------------------

def get_metadata_json():
    """Generate VM metadata for the /metadata endpoint"""
    metadata = {
        "hostname": os.environ.get('HOSTNAME_VM', 'unknown'),
        "instance_id": os.environ.get('INSTANCE_ID', 'unknown'),
        "zone": os.environ.get('ZONE', 'unknown'),
        "region": os.environ.get('ZONE', 'unknown')[:-2] if os.environ.get('ZONE') else 'unknown',
        ...
        "os": os.environ.get('OS_NAME', 'unknown'),
        "uptime": os.environ.get('UPTIME', 'unknown'),
        "cpu_usage": os.environ.get('CPU_USAGE', '0'),
        "memory_percent": os.environ.get('MEM_PERCENT', '0'),
        "disk_percent": os.environ.get('DISK_PERCENT', '0%'),
